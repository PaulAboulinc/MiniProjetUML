...
public class CatalogueTest {
	...
	public void setUp() {
		cat = new Catalogue();
//		Si votre Catalogue est un Singleton, il faut changer la ligne précédente puis vider le Catalogue avec la méthode clear() comme indiqué Ã  la ligne suivante
//		cat.clear();
	}
	...
	public void testAddProduitIProduit_deuxFoisMemeProduitConsecutif() {
		...
		I_Produit p2 = createProduit("Treets", 10, 1);
		cat.addProduit(p2);
		assertFalse("ajout deux fois mÃªme produit consécutif", cat.addProduit(p2));
	}
	...
	public void testAddProduitIProduit_deuxFoisMemeProduitNonConsecutif() {
		...
		I_Produit p2 = createProduit("Treets", 10, 1);
		cat.addProduit(p2);
		assertFalse("ajout deux fois mÃªme produit non consécutif", cat.addProduit(p1));
	}
	...
	public void testAddProduitIProduit_deuxFoisProduitMemeNomConsecutif() {
		...
		assertFalse("ajout deux produits avec mÃªme nom consécutif", cat.addProduit(p3));
	}
	...
	public void testAddProduitIProduit_deuxFoisProduitMemeNomEspacesAuDebut() {
		...
		assertFalse("ajout deux produits avec mÃªme nom mais un avec des espaces au début", cat.addProduit(p2));
	}
	...
	public void testAddProduitIProduit_deuxFoisProduitMemeNomTabulationsAuDebut() {
		...
		cat.addProduit(p1);
		I_Produit p2 = createProduit("	Mars", 15, 2);
		assertFalse("ajout deux produits avec mÃªme nom mais un avec des tabulations au début", cat.addProduit(p2));
	}
	...
	public void testAddProduitStringDoubleInt_deuxFoisMemeNomConsecutif() {
		...
		I_Produit p2 = createProduit("Treets", 10, 1);
		cat.addProduit(p2);
		assertFalse("ajout deux fois mÃªme produit consécutif", cat.addProduit("Treets", 10, 1));
	}
	...
	public void testAddProduitStringDoubleInt_deuxFoisMemeNomNonConsecutif() {
		...
		I_Produit p2 = createProduit("Treets", 10, 1);
		cat.addProduit(p2);
		assertFalse("ajout deux fois mÃªme produit non consécutif", cat.addProduit("Mars", 10, 1));
	}
	...
	public void testAddProduitStringDoubleInt_deuxFoisProduitMemeNomEspacesAuDebut() {
		I_Produit p1 = createProduit("Mars", 10, 1);
		cat.addProduit(p1);
		assertFalse("ajout deux fois mÃªme produit mais un avec espaces au début", cat.addProduit(" Mars", 10, 1));
	}
	...
	public void testAddProduitStringDoubleInt_deuxFoisProduitMemeNomTabulationsAuDebut() {
		I_Produit p1 = createProduit("Mars", 10, 1);
		cat.addProduit(p1);
		assertFalse("ajout deux fois mÃªme produit mais un avec tabulations au début", cat.addProduit("	Mars", 10, 1));
	}
	...
	public void testAddProduits_produitsAvecUnSeulDoublon() {
		...
		liste.add(p2);
		liste.add(p4);
		assertEquals("ajout liste avec un seul des produits déjÃ  dans le catalogue",3, cat.addProduits(liste));
	}
	...
	public void testAddProduits_produitsAvecCertainsDoublons() {
		...
		liste.add(p2);
		liste.add(p4);
		assertEquals("ajout liste avec plusieurs produits déjÃ  dans le catalogue",2, cat.addProduits(liste));
	}
	...
	public void testAddProduits_produitsAvecQueDesDoublons() {
		...
		liste.add(p1);
		liste.add(p2);
		assertEquals("ajout liste avec tous les produits déjÃ  dans le catalogue",0, cat.addProduits(liste));
	}
	...
	public void testGetNomProduits_unProduitAvecNomEspacesAuDebut() {
		String[] tab = {"Mars"};
		cat.addProduit(" Mars", 10, 1);
		assertArrayEquals("recupère nom produit avec espace debut ; les espaces au début ne doivent pas Ãªtre stockés", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomEspacesALaFin() {
		String[] tab = {"Mars"};
		cat.addProduit("Mars ", 10, 1);
		assertArrayEquals("recupère nom produit avec espace fin ; les espaces Ã  la fin ne doivent pas Ãªtre stockés", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomTabulationsAuDebut() {
		String[] tab = {"Mars"};
		cat.addProduit("	Mars", 10, 1);
		assertArrayEquals("recupère nom produit avec tabulation debut ; les tabulations au début ne doivent pas Ãªtre stockés", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomTabulationsALaFin() {
		String[] tab = {"Mars"};
		cat.addProduit("Mars	", 10, 1);
		assertArrayEquals("recupère nom produit avec tabulation fin ; les tabulations Ã  la fin ne doivent pas Ãªtre stockés", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomTabulationsAuMilieu() {
		String[] tab = {"Kit Kat"};
		cat.addProduit("Kit	Kat", 10, 1);
		assertArrayEquals("recupère nom produit avec des tabulations au milieu ; les tabulations au milieu doivent Ãªtre remplacées par des espaces", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_plusieursProduitsInseresOrdreAleatoire() {
		...
		assertArrayEquals("recupère nom de plusieurs produits ajoutés dans ordre aléatoire (doivent Ãªtre retournés dans l'ordre alphabétique)", tab, cat.getNomProduits());
	}
